...
import addIconImg from './images/add.svg';
import deleteIconImg from './images/delete.svg';
import editIconImg from './images/edit.svg';
...
function addEditIcon() {
  ...
  editIcon.setAttribute('src', editIconImg);
...
function addDeleteIcon() {
  ...
  deleteIcon.setAttribute('src', deleteIconImg);
...
function addProjectContent() {
  ...
  addTask.setAttribute('src', addIconImg);
